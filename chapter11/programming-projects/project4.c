...
/*
 * read_cards:
 *   Initialize the variables num_in_rank and num_in_suit.
 ...
 *   stores the results into the variables straight, flush, four, three, and pairs.
 */
void analyze_hand(int num_in_rank[], int num_in_suit[], bool *straight, bool *flush, bool *four, bool *three, int *pairs) {
  int num_consec = 0;
  int rank, suit;
 ...
 *   After printing, re-initializes the variables.
 */
void print_result(bool *straight, bool *flush, bool *four, bool *three, int *pairs) {
