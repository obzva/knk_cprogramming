...
/*
 * Repeatedly reads user guesses and tells the user whether each guess is too low, too high,
 * or correct. When the guess is correct, prints the total number of guesses and returns.
 */
void read_guesses(int secret_number) {
